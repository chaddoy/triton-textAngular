...
[![Build Status](https://travis-ci.org/chaddoy/triton-textAngular.png?branch=master)](https://travis-ci.org/chaddoy/triton-textAngular) [![Coverage Status](https://coveralls.io/repos/chaddoy/triton-textAngular/badge.png)](https://coveralls.io/r/chaddoy/triton-textAngular)
...
Download the code from [https://github.com/chaddoy/triton-textAngular/releases/latest](https://github.com/chaddoy/triton-textAngular/releases/latest), unzip the files then add script tags similar to the following:
```html
...
For Additional options see the [github Wiki](https://github.com/chaddoy/triton-textAngular/wiki).
...
You'll have to apply the renderers manually, see comment in issue [#469](https://github.com/chaddoy/triton-textAngular/issues/469#issuecomment-68650506) for details.
3. **IE Is automatically converting typed links to `<a href...>` tags**<br/>
This is a known issue with IE, to prevent this run the following javascript after page load: `document.execCommand("AutoUrlDetect", false, false)`. See [#475](https://github.com/chaddoy/triton-textAngular/issues/475) for details.
4. **Error `"textAngular Error: An editor with the name already exists"` occurs**<br/>
See Issue [#240](https://github.com/chaddoy/triton-textAngular/issues/240) for specific details on why this occurs and how to resolve it.
...
For a full list see: https://github.com/chaddoy/triton-textAngular/graphs/contributors
